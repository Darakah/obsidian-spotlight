 ...
 */
function chooseRnadomNote(fileList, tagList, metadataCache, match, currentPath, block, settings) {
...
class SpotlightProcessor {
    async run(Comp, source, el, app, settings, args, block) {
        var _a;
        ...
        let divAlign = (((_a = args[4]) === null || _a === void 0 ? void 0 : _a.trim()) == 'right') ? 'right' : 'left';
